...
export interface TerrainOptions {
    after?: (v: Vector3[], options: TerrainOptions) => void;
    easing?: EasingFunction;
    heightmap: HeightmapFunction;
    maxHeight: number;
    minHeight: number;
...
export type FeatureFunction = (
    distanceToFeatureOrigin: number,
    xDistanceToFeatureOrigin?: number,
    yDistanceToFeatureOrigin?: number
) => number;
...
export type BlendingFunction = (
    currentTerrainHeight: number,
    featureVertexDisplacement: number,
